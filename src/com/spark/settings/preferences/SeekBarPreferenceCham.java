package com.spark.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SPARKSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SPARKSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, SPARKSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SPARKSETTINGSNS, "interval");
            if(newInterval != null)
