...
package com.spark.settings.display;
...
public class AccentColorPreferenceController extends AbstractPreferenceController implements
    ...
    static final int DEFAULT_ACCENT_COLOR = 0xfffcdc33;
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        String hexColor = String.format("#%08x", (0xfffcdc33 & intColor));
        if (hexColor.equals("#fffcdc33")) {
