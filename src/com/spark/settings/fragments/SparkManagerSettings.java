/*
 * Copyright (C) 2023 Spark Project
 *
...
@SearchIndexable
public class SparkManagerSettings extends SettingsPreferenceFragment implements
        Preference.OnPreferenceChangeListener {

    public static final String TAG = "SparkManagerSettings";
    private static final String SYS_AGGRESIVE_IDLE_MODE = "spark_aggressive_idle_mode";
    private static final String SYS_BOOST = "spark_system_boost";
    private static final String SYS_MANAGER = "spark_system_manager";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.spark_settings_spark_manager);
    ...
    public static void disableSysteManagerFeatures(Context mContext) {
        ...
        Settings.System.putIntForUser(resolver,
                Settings.System.SPARK_SYSTEM_MANAGER, 0, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver,
                Settings.System.SPARK_SYSTEM_BOOST, 0, UserHandle.USER_CURRENT);
    }

    public static void disableAggressiveModeFeatures(Context mContext) {
        ContentResolver resolver = mContext.getContentResolver();
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_WIFI_TOGGLE, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_BLUETOOTH_TOGGLE, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_CELLULAR_TOGGLE, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_LOCATION_TOGGLE, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.Secure.SPARK_AGGRESSIVE_IDLE_MODE_RINGER_MODE, 0, UserHandle.USER_CURRENT);
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.spark_settings_spark_manager);
}
