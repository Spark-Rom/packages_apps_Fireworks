...
class ExtraThemes: DashboardFragment() {
    ...
    override protected fun getPreferenceScreenResId() = R.xml.extratheme_settings
    ...
    override protected fun createPreferenceControllers(
        ...
        val isAospLauncherInstalled = SparkUtils.isPackageInstalled(
            context, TARGET_LAUNCHER, false /** ignoreState */
        )
        val isAospThemePickerInstalled = SparkUtils.isPackageInstalled(
