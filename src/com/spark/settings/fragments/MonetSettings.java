/*
 * Copyright (C) 2021-2023 Spark Android Project
 *
...
import com.spark.settings.utils.WallpaperUtils;
...
public class MonetSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerView = new ColorPickerView.Builder(getContext()).setActionMode(ActionMode.LAST).setPaletteDrawable(WallpaperUtils.getWall(getContext(), false)).setPreferenceName("SparkColorPicker").setColorListener(new ColorListener() {
