...
public class QsRowSettings extends DashboardFragment {
    public static final String TAG = "QsRowSettings";
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.spark_settings_qsrows;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.spark_settings_qsrows);
}
