...
public class GvisualSettings extends SettingsPreferenceFragment implements
    ...
    private void setupNavbarSwitchPref() {
        ...
        } else if (SparkUtils.isNavbarColor("com.gnonymous.gvisualmod.pgm_orcd")){
    ...
    private void setupHeaderSwitchPref() {
        ...
        if (SparkUtils.isThemeEnabled("com.android.theme.header.xlarge")){
            mhdSize.setValue("3");
        } else if (SparkUtils.isThemeEnabled("com.android.theme.header.large")){
            mhdSize.setValue("2");
        }
        else{
            mhdSize.setValue("1");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.spark_settings_gvisual);
}
