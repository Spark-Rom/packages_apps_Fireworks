...
public class StatusbarIcons extends SettingsPreferenceFragment {
    ...
    private String mSettingsCategory = "android.theme.customization.icon_pack.settings";
    private String mSystemUICategory = "android.theme.customization.icon_pack.systemui";

    private List<String> mPkgs;
    private List<String> mSettingsPkgs;
    private List<String> mSystemUIPkgs;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getActivity().setTitle(R.string.theme_customization_system_icon_title);

        mThemeUtils = new ThemeUtils(getActivity());
        mPkgs = mThemeUtils.getOverlayPackagesForCategory(mCategory, "android");
        Collections.sort(mPkgs);
        mSettingsPkgs = mThemeUtils.getOverlayPackagesForCategory(mSettingsCategory, "com.android.settings");
        Collections.sort(mSettingsPkgs);
        mSystemUIPkgs = mThemeUtils.getOverlayPackagesForCategory(mSystemUICategory, "com.android.systemui");
        Collections.sort(mSystemUIPkgs);
    }
    ...
    public void enableOverlays(int position) {
        ...
        mThemeUtils.setOverlayEnabled(mSettingsCategory, mSettingsPkgs.get(position));
        mThemeUtils.setOverlayEnabled(mSystemUICategory, mSystemUIPkgs.get(position));
    }
}
