...
package com.spark.settings.security.applock
...
class AppLockSettingsFragment : DashboardFragment(),
    ...
    override protected fun getPreferenceScreenResId() = R.xml.spark_settings_app_lock

    override fun getMetricsCategory() = MetricsProto.MetricsEvent.SPARK_SETTINGS
